...
import com.wire.logging.LoggedTry
...
package object utils {
  ...
  implicit class RichUri(val uri: URI) extends AnyVal {
    ...
    def setUserInfo(userName: String, password: String) = new URIBuilder(uri).setUserInfo(userName, password).build()
